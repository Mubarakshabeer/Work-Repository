		...
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				<a href="{{ route('front.home') }}" class="text-decoration-none">
					<span class="h1 text-uppercase text-primary bg-dark px-2 fa-2x">Trendy</span>
					<span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1 fa-1x">Store</span>
				</a>
			</div>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                @if ($category->sub_category->isNotEmpty())
                                    <ul class="dropdown-menu dropdown-menu-dark">
                                        @foreach ($category->sub_category as $subCategoryList)
                                            <li><a class="dropdown-item nav-link" href="#">{{ $subCategoryList->name }}</a></li>
                                        @endforeach
                                    </ul>
                                @endif
                            </li>
